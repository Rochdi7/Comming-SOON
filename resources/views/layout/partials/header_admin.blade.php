                ...
                <div class="nav user-menu nav-list">
                    ...
                    <div class="me-auto d-flex align-items-center" id="header-search">					
                        ...
                        <div class="add-dropdown">
                            <a href="{{url('admin/add-reservation')}}" class="btn btn-dark d-inline-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center header-icons">	
                        ...
                        <div class="nav-item dropdown has-arrow flag-nav nav-item-box">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);"
                                role="button">
                                <img src="{{URL::asset('admin_assets/img/flags/gb.svg')}}" alt="Language" class="img-fluid">
                            </a>
                            <ul class="dropdown-menu p-2">
                                <li>
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="{{URL::asset('admin_assets/img/flags/gb.svg')}}" alt="" height="16">English
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="{{URL::asset('admin_assets/img/flags/sa.svg')}}" alt="" height="16">Arabic
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="{{URL::asset('admin_assets/img/flags/de.svg')}}" alt="" height="16">German
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-end notification-dropdown">
                                <div class="topnav-dropdown-header pb-0">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-bottom">
                                        <li class="nav-item"><a class="nav-link active" href="#active-notification" data-bs-toggle="tab">Active<span class="count ms-2">2</span></a></li>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="active-notification">
                                            <div class="notification-list">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-lg offline me-2 flex-shrink-0">
                                                        <img src="{{URL::asset('admin_assets/img/profiles/avatar-02.jpg')}}" alt="Profile" class="rounded-circle">
                                                    </a>
                                            ...
                                            <div class="notification-list">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-lg offline me-2 flex-shrink-0">
                                                        <img src="{{URL::asset('admin_assets/img/profiles/avatar-05.jpg')}}" alt="Profile" class="rounded-circle">
                                                    </a>
                                                    <div class="flex-grow-1">
                                            ...
                                            <div class="notification-list">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-lg me-2 flex-shrink-0">
                                                        <img src="{{URL::asset('admin_assets/img/profiles/avatar-04.jpg')}}" alt="Profile" class="rounded-circle">
                                                    </a>
                                                    <div class="flex-grow-1">
                                            ...
                                            <div class="notification-list">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-lg me-2 flex-shrink-0">
                                                        <img src="{{URL::asset('admin_assets/img/profiles/avatar-01.jpg')}}" alt="Profile" class="rounded-circle">
                                                    </a>
                                                    <div class="flex-grow-1">
                                        ...
                                        <div class="tab-pane fade" id="unread-notification">
                                            ...
                                            <div class="notification-list">
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-lg offline me-2 flex-shrink-0">
                                                            <img src="{{URL::asset('admin_assets/img/profiles/avatar-06.jpg')}}" alt="Profile" class="rounded-circle">
                                                        </span>
                                                        <div class="flex-grow-1">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu p-3">
                                <ul>
                                    <li>
                                        <a href="{{url('admin/add-car')}}" class="dropdown-item d-inline-flex align-items-center">
                                            <i class="ti ti-car me-2"></i>Car
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{url('admin/add-quotations')}}" class="dropdown-item d-inline-flex align-items-center">
                                            <i class="ti ti-file-symlink me-2"></i>Quotation
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{url('admin/pricing')}}" class="dropdown-item d-inline-flex align-items-center">
                                            <i class="ti ti-file-dollar me-2"></i>Seasonal Pricing
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{url('admin/extra-services')}}" class="dropdown-item d-inline-flex align-items-center">
                                            <i class="ti ti-script-plus me-2"></i>Extra Service
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{url('admin/inspections')}}" class="dropdown-item d-inline-flex align-items-center">
                                            <i class="ti ti-dice-6 me-2"></i>Inspection
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{url('admin/maintenance')}}" class="dropdown-item d-inline-flex align-items-center">
                        ...
                        <div class="dropdown profile-dropdown">
                            <a href="javascript:void(0);" class="d-flex align-items-center" data-bs-toggle="dropdown"  data-bs-auto-close="outside">
                                <span class="avatar avatar-sm">
                                    <img src="{{URL::asset('admin_assets/img/profiles/avatar-05.jpg')}}" alt="Img" class="img-fluid rounded-circle">
                                </span>
                            </a>
                            <div class="dropdown-menu">
                                <div class="profileset d-flex align-items-center">
                                    <span class="user-img me-2">
                                        <img src="{{URL::asset('admin_assets/img/profiles/avatar-05.jpg')}}" alt="">
                                    </span>
                                    <div>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="{{url('admin/profile-setting')}}">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="{{url('admin/security-setting')}}">
                                ...
                                <div class="dropdown-divider my-2"></div>
                                <a class="dropdown-item logout d-flex align-items-center justify-content-between" href="{{url('admin/login')}}">
